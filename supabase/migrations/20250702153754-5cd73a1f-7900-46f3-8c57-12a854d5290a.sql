...
-- Remove usuario_id from empresas table since we now have N:N relationship
...
-- Update empresas RLS policies to work with new structure
...
-- Update RLS policies for sessoes, conversoes, campanhas to use new structure
